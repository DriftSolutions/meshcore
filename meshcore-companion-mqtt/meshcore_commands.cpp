...
void queue_packet_get_message() {
	...
	pack->expected_responses = { RESPONSE_CODE_CHANNEL_MSG_RECV, RESPONSE_CODE_CHANNEL_MSG_RECV_V3, RESPONSE_CODE_CONTACT_MSG_RECV, RESPONSE_CODE_CONTACT_MSG_RECV_V3, RESPONSE_CODE_CHANNEL_DATA_RECV, RESPONSE_CODE_NO_MORE_MSGS, RESPONSE_CODE_STATUS_RESPONSE };
	outgoing_commands.push_back(pack);
}
